...
class MarkdownText(ctk.CTkTextbox):
    """
    CTkTextbox avec rendu Markdown minimal :
    - **gras**, *italique*
    - Titres (#, ##, ###)
    - Listes (- , * )
    ...
    def __init__(self, parent, **kwargs):
        ...
        # IMPORTANT : tag_* et bind doivent cibler le Text interne :
        self._t = self._textbox  # tkinter.Text interne de CTkTextbox
    ...
    def _insert_inline(self, text: str, extra_tags: tuple[str, ...] = ()):
        ...
        Ordre: liens -> code -> gras -> italique (pour éviter conflits).
        """
        idx = 0
        while idx < len(text):
            # Liens
            ...
            # Choisir le prochain match le plus proche
    ...
    def _insert_link(self, label: str, url: str, extra_tags: tuple[str, ...]):
        ...
        # Bind sur le Text interne
        self._t.tag_bind(tag, "<Button-1>", lambda e, u=url: webbrowser.open_new(u))
